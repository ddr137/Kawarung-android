...
class CartViewModel : ViewModel() {
    ...
    fun fetchProductCart(id_user: String, token: String) {
        ...
        api.listCart(id_user, token).enqueue(object :
            Callback<WrappedResponse<Data<com.nahltech.kawarung.data.models.cart.Product>>> {
            override fun onFailure(
                call: Call<WrappedResponse<Data<com.nahltech.kawarung.data.models.cart.Product>>>,
                t: Throwable
            ) {
            ...
            override fun onResponse(
                call: Call<WrappedResponse<Data<com.nahltech.kawarung.data.models.cart.Product>>>,
                response: Response<WrappedResponse<Data<com.nahltech.kawarung.data.models.cart.Product>>>
            ) {
                if (response.isSuccessful) {
                    val body =
                        response.body() as WrappedResponse<Data<com.nahltech.kawarung.data.models.cart.Product>>
