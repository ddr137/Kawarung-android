...
import kotlinx.android.synthetic.main.activity_trend_product.*

class TrendProductActivity : AppCompatActivity() {
    private lateinit var homeViewModel: HomeViewModel
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_trend_product)
        setupRecycler()
        setupViewModel()
        toolbarUI()
    }
